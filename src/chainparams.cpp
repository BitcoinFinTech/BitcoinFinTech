...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 14 * 24 * 60 * 60; // two weeks, TODO: this is the difficulty retarget time
        consensus.nPowTargetSpacing = 10 * 60;  // TODO: this is the block time
        ...
        nDefaultPort = 8333;    //TODO: The port
